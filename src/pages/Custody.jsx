      ...
      <div className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 px-3 py-3 backdrop-blur md:px-6">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="flex max-w-full gap-2 overflow-x-auto rounded-2xl border border-slate-200 bg-slate-50 p-1">
              {custodyTabs.map((tab) => {
                const Icon = tab.icon;
                ...
                return (
                  <button
                    ...
                    className={`flex min-w-fit items-center gap-2 rounded-xl px-3 py-2 text-xs font-black transition md:text-sm ${
                      active
