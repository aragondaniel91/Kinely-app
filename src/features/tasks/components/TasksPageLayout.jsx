...
export default function TasksPageLayout({ children }) {
  return (
    <div className="relative min-h-full overflow-hidden bg-background px-3 pb-28 pt-2 md:px-6 md:pb-12">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-10 left-1/3 h-80 w-80 rounded-full bg-secondary/70 blur-3xl" />
      </div>
