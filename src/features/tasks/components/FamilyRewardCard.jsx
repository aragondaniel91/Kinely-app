...
export default function FamilyRewardCard({ reward, allTasks }) {
  ...
  return (
    <Card className="rounded-[2rem] border-violet-200 bg-gradient-to-br from-violet-50 via-purple-50 to-white p-5 shadow-[0_18px_45px_rgba(86,60,135,0.08)]">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex h-20 w-20 items-center justify-center rounded-[1.7rem] bg-white/80 shadow-inner">
          <Pizza className="h-10 w-10 text-violet-700" />
        </div>
      </div>
