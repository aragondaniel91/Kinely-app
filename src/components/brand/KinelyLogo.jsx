...
export default function KinelyLogo({ showWordmark = true, className = "", markClassName = "" }) {
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      ...
      >
        <defs>
          <linearGradient id="kinelyMarkWarm" x1="12" y1="10" x2="44" y2="62" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFB24C" />
            <stop offset="1" stopColor="#FF7B72" />
          </linearGradient>
          <linearGradient id="kinelyMarkBlue" x1="58" y1="8" x2="26" y2="58" gradientUnits="userSpaceOnUse">
            <stop stopColor="#6FA6F7" />
            <stop offset="1" stopColor="#5B8DEF" />
          </linearGradient>
          <linearGradient id="kinelyMarkGreen" x1="24" y1="38" x2="46" y2="62" gradientUnits="userSpaceOnUse">
            <stop stopColor="#7BC9A1" />
            <stop offset="1" stopColor="#55B98D" />
          </linearGradient>
        </defs>

        <circle cx="18" cy="15" r="7.5" fill="url(#kinelyMarkWarm)" />
        <circle cx="54" cy="15" r="7.5" fill="url(#kinelyMarkBlue)" />
      ...
      {showWordmark && (
        <span className="kinely-wordmark text-3xl font-semibold leading-none tracking-normal">
          Kinely
        </span>
      )}
    </div>
