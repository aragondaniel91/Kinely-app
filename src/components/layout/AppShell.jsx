...
export default function AppShell() {
  ...
  return (
    <div className="flex min-h-dvh flex-col overflow-x-hidden bg-[#fbfaf6]">
      <header className="sticky top-0 z-40 bg-[#fbfaf6]/95 px-3 py-2.5 backdrop-blur-xl md:px-6 md:py-3">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-3 py-2 md:px-4">
      ...
      <nav className="pointer-events-none fixed inset-x-0 bottom-0 z-50 px-3 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))]">
        <div className="pointer-events-auto mx-auto max-w-3xl rounded-[1.85rem] border border-white/70 bg-white/62 p-1.5 shadow-[0_18px_42px_rgba(15,23,42,0.10)] backdrop-blur-2xl transition hover:bg-white/76">
