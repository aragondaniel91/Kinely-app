    ...
    <div className="border-b border-slate-200 bg-white px-6 py-5">
      <div className="grid grid-cols-[minmax(300px,1fr)_auto] gap-x-8 gap-y-5">
        ...
        <div className="flex flex-wrap items-center justify-end gap-3">
          <button className="h-10 rounded-xl border border-slate-200 bg-white px-4 text-sm font-bold text-slate-600 shadow-sm hover:bg-slate-50">
            Sync calendar
          </button>
          <button className="h-10 min-w-[160px] rounded-xl border border-slate-200 bg-white px-3 text-left text-sm font-bold text-slate-600 shadow-sm hover:bg-slate-50">
            Person <span className="text-xs font-semibold text-slate-400">All</span>
          </button>
          <button className="h-10 min-w-[180px] rounded-xl border border-slate-200 bg-white px-3 text-left text-sm font-bold text-slate-600 shadow-sm hover:bg-slate-50">
            Category <span className="text-xs font-semibold text-slate-400">All Categories</span>
          </button>
        </div>
        ...
        <div className="col-span-2 flex flex-wrap items-center gap-2">
          {people.map((person, index) => (
            <button
              ...
              className={
                index === 0
                  ? "rounded-full border border-blue-600 bg-blue-600 px-3 py-1.5 text-sm font-bold text-white shadow-sm"
                  : "rounded-full border border-slate-200 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 hover:bg-slate-50"
              }
            >
              {person}
            </button>
