...
function FamilyLogoHeader({ eventSummary }) {
  return (
    <div className="flex items-center gap-3 min-w-0">
      ...
      <div className="min-w-0">
        <p className="truncate text-xl font-black text-slate-950">Family Wall</p>
        <p className="truncate text-xs font-semibold text-slate-400">{eventSummary}</p>
      </div>
    </div>
  );
}
...
export default function FamilyCalendarViewV8({ activeCalendar = "family", setActiveCalendar, viewMode = "week", setViewMode }) {
    ...
    <div className="min-h-full bg-[#f8fbff] p-2 md:p-4">
      <div className="mx-auto max-w-none overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 bg-white px-4 py-4 md:px-8">
          <div className="flex flex-wrap items-start justify-between gap-4 pr-48 md:pr-72">
            <FamilyLogoHeader eventSummary={eventSummary} />
            <div className="ml-auto inline-flex overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2 pr-48 md:pr-72">
            ...
            <button type="button" className="flex h-10 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-sm font-bold text-slate-600 shadow-sm hover:bg-slate-50">
      ...
      <button
        ...
        className="fixed bottom-24 right-6 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 text-white shadow-2xl transition hover:scale-105 hover:bg-blue-700 md:bottom-8 md:right-8"
