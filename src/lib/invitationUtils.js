...
export function buildFamilyInvitation({
  ...
  return {
    ...
    livesHere: livesHere === true,
    lives_here: livesHere === true,
    showOnHomeDashboard: showOnHomeDashboard === true,
    show_on_home_dashboard: showOnHomeDashboard === true,
    homeDashboard: showOnHomeDashboard === true,
    home_dashboard: showOnHomeDashboard === true,
    color: color || "",
    colorId: color || "",
    color_id: color || "",
    familyColor: color || "",
    ...
    isAdmin: admin === true,
    is_admin: admin === true,
    appRole: appRole || (admin === true ? "admin" : "viewer"),
    app_role: appRole || (admin === true ? "admin" : "viewer"),
