...
export function AuthProvider({ children }) {
  ...
  const loadProfile = async (firebaseUser) => {
    ...
    if (!data.familyId) {
      ...
      await setDoc(familyRef, {
        ...
        parent1Color: parentRole === "mom" ? "orange" : "blue",
        parent1_color: parentRole === "mom" ? "orange" : "blue",
        parent2Name: "",
        parent2_name: "",
        parent2Email: "",
        parent2_email: "",
        ...
        parent2Color: parentRole === "mom" ? "blue" : "orange",
        parent2_color: parentRole === "mom" ? "blue" : "orange",
        children: [],
        members: [
          {
  ...
  const register = async ({
    ...
    await setDoc(familyRef, {
      ...
      parent1Color: cleanRole === "mom" ? "orange" : "blue",
      parent1_color: cleanRole === "mom" ? "orange" : "blue",
      ...
      parent2Color: cleanRole === "mom" ? "blue" : "orange",
      parent2_color: cleanRole === "mom" ? "blue" : "orange",
